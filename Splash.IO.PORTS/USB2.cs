...
using static Splash.IO.PORTS.USB2;

namespace Splash.IO.PORTS
{
    public struct HostControllerInfo// USB主控制器信息
    {
        public String PNPDeviceID;      // 设备ID
        public String Name;             // 设备名称
    }
    public struct UsbHubInfo// USB Hub信息
    {
        public String PNPDeviceID;      // 设备ID
        public String Name;             // 设备名称
        public String Status;           // 设备状态
    }
    public struct UsbNodeInformation// USB HUB节点信息
    {
    ...
    public struct UsbDeviceDescriptor// USB设备描述符
    {
    ...
    public struct UsbPipeInfo// USB管道信息
    {
    ...
    public struct UsbNodeConnectionInformation// USB节点连接信息
    {
        public String DevicePath;           // 设备路径
    ...
    {
        public static HostControllerInfo[] AllHostControllers// USB主控制器
        {
            get
            {
        ...
        public static String GetHcdDriverKeyName(String PNPDeviceID)//获取驱动键名 PNPDeviceID USB主控制器设备ID
        {
        ...
        public static UInt16 SelectLanguageID(IntPtr hHubDevice, Int32 ConnectionIndex)
        {
            ...
            UInt16 UserDefaultUILanguage = 0;
